...
var en = {
  ...
  strings: {
    ...
    HEADING_LONG: 'Heading is long! Headings should be used to organize content and convey structure. They should be brief, informative, and unique. Please keep headings less than 70 characters (no more than a sentence). <hr> Character count: <strong {r}>%(headingLength)</strong>',
